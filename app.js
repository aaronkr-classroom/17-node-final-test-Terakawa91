...
router.post("/discussions/create", discussionsController.create, discussionsController.redirectView); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
...
router.put("/discussions/:id/update", discussionsController.update, discussionsController.redirectView); // 편집 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
